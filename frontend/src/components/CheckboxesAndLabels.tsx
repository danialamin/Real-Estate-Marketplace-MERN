  ...
  return (
    <div className="flex flex-wrap gap-[6px]">
      <div className="flex gap-[3px]">
        <input type="checkbox" id="sell" className="w-[16px]" />
        <label htmlFor="sell" className="text-[0.95rem]">Sell</label>
      </div>
      <div className="flex gap-[3px]">
        <input type="checkbox" id="rent" className="w-[16px]" />
        <label htmlFor="rent" className="text-[0.95rem]">Rent</label>
      </div>
      <div className="flex gap-[3px]">
        <input type="checkbox" id="parkingSpot" className="w-[16px]" />
        <label htmlFor="parkingSpot" className="text-[0.95rem]">Parking Spot</label>
      </div>
      <div className="flex gap-[3px]">
        <input type="checkbox" id="furnished" className="w-[16px]" />
        <label htmlFor="furnished" className="text-[0.95rem]">Furnished</label>
      </div>
      <div className="flex gap-[3px]">
        <input type="checkbox" id="offer" className="w-[16px]" />
