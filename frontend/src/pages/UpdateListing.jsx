...
const UpdateListing = () => {
  ...
  useEffect(() => {
    const fetchListing = async () => {
      ...
      const res = await fetch(`https://real-estate-marketplace-mern-server-nu.vercel.app/getListing/${listingId}`)
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await fetch(`https://real-estate-marketplace-mern-server-nu.vercel.app/listing/updateMyListing/${currentUser._id}`, {
      method: 'POST',
