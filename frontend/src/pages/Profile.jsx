...
const Profile = () => {  
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    try {
      const res = await fetch(`https://real-estate-marketplace-mern-server-nu.vercel.app/api/auth/updateUser/${currentUser._id}`, {
        method: 'POST',
        credentials: 'include',
  ...
  const handleDelete = async () => {
    const res = await fetch(`https://real-estate-marketplace-mern-server-nu.vercel.app/api/auth/deleteUser/${currentUser._id}`, {
      method: 'DELETE',
      credentials: 'include'
    })
    const data = await res.json()
  ...
  const handleSignOut = async () => {
    const res = await fetch(`https://real-estate-marketplace-mern-server-nu.vercel.app/api/auth/signOut/${currentUser._id}`, {
      method: 'GET',
      credentials: 'include'
    })
    const data = await res.json()
  ...
  const handleShowListings = async () => {
    const res = await fetch(`https://real-estate-marketplace-mern-server-nu.vercel.app/listing/myListing/${currentUser._id}`, {
      method: 'GET',
      credentials: 'include'
    })
    const data = await res.json()
  ...
  const handleDeleteListing = async (listingId) => {
    const res = await fetch(`https://real-estate-marketplace-mern-server-nu.vercel.app/listing/deleteMyListing/${currentUser._id}`, {
      method: 'POST',
      headers: {'Content-Type': 'application/json'},
      credentials: "include",
